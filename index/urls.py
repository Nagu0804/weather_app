...
urlpatterns = [
    ...
    path('reset/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name="index/recovery/password_reset_confirm.html"), name='password_reset_confirm'),
